...
class EurekaPrometheusBridgeApplicationTests {
    ...
    fun testGenerator() {
        ...
        var resource = ClassPathResource(Generator.config.get(PrometheusProperties.testConfigFilePath)) //null if empty
        var resource2 = ClassPathResource(Generator.config.get(PrometheusProperties.generatedConfigFilePath)) //null if empty
